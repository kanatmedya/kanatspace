...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $salaryRoad = $_POST['salaryRoad'] ?? 'false';
    ...
    $sql = "UPDATE users_employee 
            SET name='$name', department='$department', position='$position', phone_num='$phone_num', email='$email', password='$password', dateStart='$dateStart', salary='$salary', salaryFood='$salaryFood', salaryRoad='$salaryRoad', annualLeave='$annualLeave', workDays='$workDays', workHourStart='$workHourStart', workHourEnd='$workHourEnd'
            WHERE id='$id'";
    ...
    <div x-data="invoiceAdd">
        <div class="flex flex-col gap-2.5 xl:flex-row">
            <div class="panel flex-1 px-0 py-6 ltr:lg:mr-6 rtl:lg:ml-6">
                <div class="px-4">
                    <form method="POST" id="employee-form" action="update_employee.php?id=<?php echo $id; ?>">
                        <div class="flex flex-col justify-between lg:flex-row" id="client-info">
                            ...
                            <div class="w-full lg:w-1/2">
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <input type="date" name="dateStart" class="form-input flex-1" 
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <select name="salaryFood" required class="form-input flex-1">
                                        <option value="false" <?php if ($row['salaryFood'] == 'false') echo 'selected'; ?>>Verilmiyor</option>
                                        <option value="true" <?php if ($row['salaryFood'] == 'true') echo 'selected'; ?>>Veriliyor</option>
                                    </select>
                                </div>
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <select name="salaryRoad" required class="form-input flex-1">
                                        <option value="false" <?php if ($row['salaryRoad'] == 'false') echo 'selected'; ?>>Verilmiyor</option>
                                        <option value="true" <?php if ($row['salaryRoad'] == 'true') echo 'selected'; ?>>Veriliyor</option>
                                    </select>
                                </div>
