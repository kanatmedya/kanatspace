...
echo'<script>
    document.title = "Müşteri Carileri | '.$companyName.'";
</script>';

//Tablodaki Bilgiler İçin Sorgu
$sqlTotal = "SELECT id FROM users_client WHERE accountType = 'client'";
...
$countSql = "SELECT COUNT(*) AS total FROM users_client WHERE accountType = 'client'";
                                            ...
                                            echo "<td>
                                                    <div class='flex items-center gap-2'>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href='client?id={$row['id']}  ' class='font-semibold text-primary hover:underline line-clamp-1 whitespace-normal'>
                                                                {$row['username']}
                                                            </a>
                                                        </div>
                                                    </div>
