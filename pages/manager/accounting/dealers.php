...
$sql = "SELECT id, name, stock, price, photos FROM products";
...
$sql = "SELECT id, name, stock, price, photos, updateDate FROM products LIMIT $itemsPerPage OFFSET $offset";
$result = $conn->query($sql);
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <h1 style="font-size:24px;margin-right:20px">Bayi Carileri</h1><br>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo 10; ?></p>
                    <h5 class="text-xs text-[#506690]">Tamamlanan Satış (Adet)<!-- invoices tablosundaki toplam tamamlanmış (completed) satış (sale) --></h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo 10 ?></p>
                    <h5 class="text-xs text-[#506690]">Satış Bakiye (₺)<!-- invoices tablosundaki tamamlanmış (completed) satış (sale) ların tutar (amount) kısmının toplamı--></h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo 10?></p>
                    <h5 class="text-xs text-[#506690]">Kalan Bakiye (₺)<!-- accounting_transactions tablosundaki categorySub 'Müşteri Tahsilatı' olanların toplamı yukarıdaki satış bakiyeden çıkartılacak  --></h5>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            echo "<td>
                                                    <div class='flex items-center gap-2'>
                                                        <div class='p-px bg-white-dark/30 rounded w-max'>
                                                            <img class='h-8 w-8 rounded object-cover' src='{$row['photos']}' alt='{$row['name']}'>
                                                        </div>
                                                        <div>

                                                            <a href='productUpdate.php?id={$row['id']}  ' class='font-semibold text-primary hover:underline line-clamp-1 whitespace-normal'>
                                                                {$row['name']}
                                                            </a>
                                                        </div>
                                                    </div>
                                                  </td>";
                                            echo "<td><div class='font-semibold'>{$row['stock']}</div></td>";
                                            echo "<td><div class='font-semibold'>{$row['price']}</div></td>";
                                            echo "<td><div class='font-semibold'>{$row['price']}</div></td>";
                                            echo "<td><div class='font-semibold'>{$row['updateDate']}</div></td>";
                                            echo "<td>
