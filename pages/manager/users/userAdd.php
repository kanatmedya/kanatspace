<div class="main-container min-h-screen text-black dark:text-white-dark">
            <div x-data="auth">
                ...
                >
                    ...
                    >
                        <div
                            class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px]"
                        >
                            <div class="mx-auto w-full max-w-[440px]">
                                <div class="mb-10">
                                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Hesap Oluştur</h1>
                                </div>
                                <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'">
                                    <div>
                                        <label for="nickname">Firma Adı</label>
                                        <div class="relative text-white-dark">
                                            <input id="nickname" type="text" placeholder="Firma Adı" class="form-input ps-10 placeholder:text-white-dark" />
