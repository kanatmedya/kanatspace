<?php
    $sqlTab = "SELECT * FROM invoices WHERE status = 'onOrder'";
    $resTab = $conn->query($sqlTab);
    $totalNum = $resTab->num_rows;
    
    $sqlTotalSum = "SELECT SUM(amount) as amount FROM invoices WHERE status = 'onOrder'";
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <h1 style="font-size:24px;margin-right:20px">Siparişler</h1><br>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    ...
                    <h5 class="text-xs text-[#506690]">Toplam Sipariş Sayısı</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    ...
                    <h5 class="text-xs text-[#506690]">Toplam Sipariş Tutarı</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    ...
                    <h5 class="text-xs text-[#506690]">Alınan Sipariş</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    ...
                    <h5 class="text-xs text-[#506690]">Verilen Sipariş</h5>
                </div>
            </div>
        </div>
    </div>
