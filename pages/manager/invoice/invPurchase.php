<?php
    //Tamamlanan Alış faturalarını çekiyor
    $sqlTab = "SELECT * FROM invoices WHERE type = 'purchase' AND status='completed'";
    $resTab = $conn->query($sqlTab);
    
    //Tamamlanan Alış Faturalarının Sayısını Hesaplıyor
    $totalNum = $resTab->num_rows;

    //Tamamlanan Alış Faturalarının Toplam Tutarını Hesaplıyor
    $sqlTotalSum = "SELECT SUM(amount) as amount FROM invoices WHERE type = 'purchase' AND status='completed'";
    ...
    $sqlSumPayment = "SELECT SUM(amount) as amount FROM accounting_transactions WHERE category = 'invPayment'";
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <h1 style="font-size:24px;margin-right:20px">Alış Faturaları</h1><br>
