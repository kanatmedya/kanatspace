<?php
    ...
    $sqlTab = "SELECT * FROM dispatch WHERE type = 'sale'";
    ...
    $sqlTotalSum = "SELECT SUM(amount) as amount FROM dispatch WHERE type = 'sale'";
...
<?php
$sql = "SELECT * FROM dispatch WHERE type = 'sale'";
$result = $conn->query($sql);
$totalResults = $result->num_rows;
?>
<?php
// Tüm ürünlerin sayısını alacak sorgu
$countSql = "SELECT COUNT(*) AS total FROM dispatch  WHERE type = 'sale'";
...
$sql = "SELECT * FROM dispatch WHERE type = 'sale' LIMIT $itemsPerPage OFFSET $offset";
$result = $conn->query($sql);
