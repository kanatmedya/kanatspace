...
<link rel="stylesheet" href="/pages/manager/projectAddModal.css">

<div id="projectAddModal" class="modal hidden">
    <div class="projectAddModal-Content">
        <div class="mb-4">
        ...
        <form id="projectForm" method="post">
            <div class="panel grid grid-rows gap-4 px-6 pt-6">
                ...
                <!-- Proje Türü ve Teslim Tarihi -->
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <p>Teslim Tarihi</p>
                        <div class="flex">
                            <input type="date" name="deadlineDate" class="form-input rounded-none rounded-tl-md rounded-bl-md" value="<?php echo date('Y-m-d'); ?>" />
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <p>Görevliler</p>
                        <input name="employee" id="employee" type="text" class="form-input text-white-dark" placeholder="Lütfen Sistemde Kayıtlı Tam Adı Giriniz"/>
                        <input type="hidden" id="employeeId" name="employeeId"> <!-- Seçilen görevlinin ID'si -->
                    </div>
            ...
            <button type="submit" class="btn btn-success w-full gap-2 mt-5" id="saveNewProjectButton">
                Kaydet
            </button>
        </form>
    </div>
...
<!-- Project Add Modal -->
<script src="assets/js/projects/projectAdd.js"></script>