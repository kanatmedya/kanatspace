...
$sql = "SELECT * FROM accounting_scheduled_payments 
        WHERE (recurrence_period = 'taksit' AND repeat_count <> created_count)
        OR (recurrence_period != 'taksit' AND (repeat_count IS NULL OR repeat_count <> created_count)) 
        ORDER BY id";
    ...
    <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    ...
                    <h5 class="text-xs text-[#506690]">Aktif Tekrar</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo '-'; ?></p>
                    <h5 class="text-xs text-[#506690]">Sonsuz Tekrar</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo '-'; ?></p>
                    <h5 class="text-xs text-[#506690]">Periyodik Tekrar</h5>
                </div>
            </div>
        </div>
        ...
        <div class="panel h-full p-0">
            <div class="flex p-5">
                ...
                <div class="font-semibold ltr:ml-3 rtl:mr-3">
                    <p class="text-xl dark:text-white-light"><?php echo '-'; ?></p>
                    <h5 class="text-xs text-[#506690]">Taksitli İşlem</h5>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-sortable="" style="width: 10.5118%;">
                                            <a href="#" class="dataTable-sorter">Tekrar</a>
                                        </th>
                                        <th data-sortable="" style="width: 10.0968%;">
                                            <a href="#" class="dataTable-sorter">Aylık Ödeme</a>
                                        </th>
                                        <th data-sortable="" style="width: 10.0968%;">
                                            <a href="#" class="dataTable-sorter">Ana Para</a>
                                        </th>
                                        <th data-sortable="" style="width: 11.2725%;">
                                            <a href="#" class="dataTable-sorter">Ödeme</a>
                                        </th>
                                        <th data-sortable="" style="width: 11.2725%;">
                                            <a href="#" class="dataTable-sorter">Son Ödeme</a>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $repeatTotal = ($row['repeat_count'] == -1) ? '∞' : $row['repeat_count'];
                                            $repeat = $row['created_count'] . '/' . $repeatTotal;
                                            
                                            $amountTotal = formatCurrency(!empty($row['installment_amount']) ? $row['total_amount'] : '∞','₺');
                                            $amountInstallment = formatCurrency(!empty($row['installment_amount']) ? $row['installment_amount'] : $row['total_amount'],'₺');
                                    
                                            $dateFormatted = date('d F Y', strtotime($row['next_due_date']));
                                            $nextDate = str_replace(array_keys($months), array_values($months), $dateFormatted);
                                            
                                            $lastDate = calculateDueDate($row['created_count'],$row['installment_count'],$row['next_due_date'],$row['recurrence_period']);
                                            
                                            $arama = $row['reciever'] . ' ' . $row['sender'] . ' ' . $nextDate . ' ' . $lastDate;
                                            ...
                                            echo "<td><div class='font-semibold'>{$repeat}</div></td>";
                                            echo "<td><div class='font-semibold'>{$amountInstallment}</div></td>";
                                            echo "<td><div class='font-semibold'>{$amountTotal}</div></td>";
                                            echo "<td><div class='font-semibold'>{$nextDate}</div></td>";
                                            echo "<td><div class='font-semibold'>{$lastDate}</div></td>";
                                            echo "<td>
