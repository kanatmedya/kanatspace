    ...
    <td>
        <div class="flex items-center font-semibold">
            <div class="p-0.5 bg-white-dark/30 rounded-full w-max ltr:mr-2 rtl:ml-2">
                <img class="h-8 w-8 rounded-full object-cover" src="<?php $rowTab['clientPhoto'] ?>">
            </div>
            <?php echo $rowTab['clientName'] ?>
        </div>
    </td>
    
    <td><?php echo $rowTab['description'] ?></td>
    
    <td>
        <div class="font-semibold"><?php echo $rowTab['amount'] ?></div>
    </td>
