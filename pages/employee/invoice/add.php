        ...
        <div class="flex flex-col gap-2.5 xl:flex-row">
                ...
                <div class="flex flex-wrap justify-between px-4">
                    <div class="mb-6 w-full lg:w-1/2">
                        ...
                        <div class="mt-6 space-y-1 text-gray-500 dark:text-gray-400">
                            <div>Kuruköprü Mah. Sefa Özler Cad. No:36 Seyhan/Adana</div>
                            <div>emin@kanatmedya.com</div>
                            <div>0533 566 61 01</div>
                        </div>
                    </div>
                    <div class="w-full lg:w-1/2 lg:max-w-fit">
                        <div class="flex items-center">
                            <label for="number" class="mb-0 flex-1 ltr:mr-2 rtl:ml-2">Belge No</label>
                            <input
                                id="number"
                                type="text"
                                name="inv-num"
                                ...
                                placeholder="#8801"
                                x-model="params.invoiceNo"
                            />
                        </div>
                        <div class="mt-4 flex items-center">
                            <label for="invoiceLabel" class="mb-0 flex-1 ltr:mr-2 rtl:ml-2">Belge Başlığı</label>
                            <input
                                id="invoiceLabel"
                                type="text"
                                name="inv-label"
                        ...
                        <div class="mt-4 flex items-center">
                            <label for="startDate" class="mb-0 flex-1 ltr:mr-2 rtl:ml-2">Belge Tarihi</label>
                            <input
                                id="startDate"
                                type="date"
                                name="inv-date"
                        ...
                        <div class="mt-4 flex items-center">
                            <label for="dueDate" class="mb-0 flex-1 ltr:mr-2 rtl:ml-2">Son Ödeme Tarihi</label>
                            <input id="dueDate" type="date" name="due-date" class="form-input w-2/3 lg:w-[250px]" x-model="params.dueDate" />
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 px-4">
                    <div class="flex flex-col justify-between lg:flex-row">
                        <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                            <div class="text-lg font-semibold">Alıcı</div>
                            <div class="mt-4 flex items-center">
                            ...
                            <div class="mt-4 flex items-center">
                                <label for="reciever-email" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">e-Mail</label>
                                <input
                                    id="reciever-email"
                                    type="email"
                                    name="reciever-email"
                        ...
                        <div class="w-full lg:w-1/2">
                            <div class="text-lg font-semibold">Ödeme Bilgileri</div>
                            <div class="mt-4 flex items-center">
                                <label for="acno" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">Hesap Numarası</label>
                                <input
                                    id="acno"
                                    type="text"
                                    name="acno"
                            ...
                            <div class="mt-4 flex items-center">
                                <label for="bank-name" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">Banka Adı</label>
                                <input
                                    id="bank-name"
                                    type="text"
                                    name="bank-name"
                            ...
                            <div class="mt-4 flex items-center">
                                <label for="swift-code" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">SWIFT</label>
                                <input
                                    id="swift-code"
                                    type="text"
                                    name="swift-code"
                                    ...
                                    placeholder="SWIFT Bilgisi Girin"
                                />
                            </div>
                            <div class="mt-4 flex items-center">
                                <label for="iban-code" class="mb-0 w-1/3 ltr:mr-2 rtl:ml-2">IBAN</label>
                                <input
                                    id="iban-code"
                                    type="text"
                                    name="iban-code"
                                    ...
                                    placeholder="IBAN Bilgisi Girin"
                                />
                            </div>
                            <div class="mt-4 flex items-center">
                            ...
                            <tbody>
                                ...
                                <template x-for="(item, i) in items" :key="i">
                                    <tr class="border-b border-[#e0e6ed] align-top dark:border-[#1b2e4b]">
                                        ...
                                        <td><input type="number" class="form-input w-32" placeholder="Adet" x-model="item.quantity" /></td>
                                        <td><input type="text" class="form-input w-32" placeholder="Price" x-model="item.amount" /></td>
                                        <td><input type="text" class="form-input w-32" placeholder="Vergi Oranı" x-model="item.tax" /></td>
                                        <td x-text="`${item.amount * item.quantity /100 * item.tax }`" x-model="item.taxSum"></td>
                                        <td x-text="`${item.amount * item.quantity + item.taxSum}₺`"></td>
                                        <td>
            ...
            <div class="mt-6 w-full xl:mt-0 xl:w-96">
                <div class="panel mb-5">
                    ...
                    <div class="mt-4">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input id="tax" type="number" name="tax" class="form-input" placeholder="Vergi" x-model="tax" />
                            </div>
                            <div>
                    ...
                    <div class="mt-4">
                        <div>
                            <label for="shipping-charge">Lojistik (₺) </label>
                            <input
                                id="shipping-charge"
                                type="number"
                                name="shipping-charge"
                                class="form-input"
                                placeholder="Lojistik Ücreti"
                                x-model="shippingCharge"
                            />
                        </div>
                    </div>
                    <div class="mt-4">
                        <label for="payment-method">Kabul Edilen Ödeme Yöntemleri</label>
