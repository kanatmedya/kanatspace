        ...
        <form id="projectForm" method="post">
            <div class="panel grid grid-rows gap-4 px-6 pt-6">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                    ...
                    <div>
                        <p>Proje Başlığı</p>
                        <input name="title" required type="text" placeholder="" class="form-input" />
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <input type="date" name="deadlineDate"
                                class="form-input rounded-none rounded-tl-md rounded-bl-md"
                                value="<?php echo date('Y-m-d'); ?>" />
                            <input type="time" name="deadlineTime"
                                class="form-input rounded-none rounded-tr-md rounded-br-md" value="18:30" />
                        </div>
                    </div>

                </div>

                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
                    <!-- Gönderici -->
                    <div>
                        ...
                        <select name="client" required class="form-select text-white-dark">
                            ...
                            echo'<option class="font-semibold" value="" disabled></option>';
                            echo'<option class="font-semibold" value="" disabled><strong>Müşteriler</strong></option>';
                            ...
                            echo'<option class="font-semibold" value="" disabled></option>';
                            echo'<option class="font-semibold" value="" disabled><strong>Bayiler</strong></option>';
                            ...
                            echo'<option class="font-semibold" value="" disabled></option>';
                            echo'<option class="font-semibold" value="" disabled><strong>Tedarikçiler</strong></option>';
                    ...
                    <div>
                        ...
                        <select name="visibility" class="form-select text-white-dark">
                            <option value="hidden">Sadece Görevli</selectedoption>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <p>Görevliler</p>
                        <input name="employee" required tyoe="text" class="form-input text-white-dark" placeholder="<?php echo $_SESSION['name']?>" disabled value="<?php echo $_SESSION['name']?>"/>
                    </div>
                </div>

                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1">
                    <p>Açıklama</p>
                    <textarea name="description" type="text" placeholder="" class="form-input"
...
<div id="allNotificationsModal" class="modal hidden fixed inset-0 flex items-center justify-center z-50">
    <div class="modal-container w-full max-w-3xl mx-auto rounded shadow-lg overflow-y-auto" style="z-index:999999">
        <div class="modal-content" style="height: 90vh;padding:0">
            <div class="mt-3 p-4 flex items-start justify-between border-b border-[#e0e6ed] pt-0 dark:border-[#1b2e4b] dark:text-white-light">
                <h2 class="text-2xl font-semibold">Tüm Yorumlar</h2>
                <button id="closeModal_AllComments" class="cursor-pointer text-black" style="font-size: x-large;">&times;</button>
            </div>
            <div class="modal-body p-4 max-h-[90vh] overflow-y-auto" id="all-notifications-list">
...
<!-- Project Add Modal -->
<script src="pages/employee/scrumboard/modules/projectAdd.js"></script>

<!-- Scrumboard Shortable -->
<script>
    ...
    document.addEventListener('alpine:init', () => {
        ...
        Alpine.data('analytics', () => ({
            init() {
                ...
                const totalVisit1 = null;
                const paidVisit = null;
                const paidVisit1 = null;
                ...
                setTimeout(() => {
                    ...
                    this.totalVisit1 = new ApexCharts(this.$refs.totalVisit1, this.totalVisitOptions);
                    this.totalVisit1.render();

                    this.paidVisit = new ApexCharts(this.$refs.paidVisit, this.paidVisitOptions);
                    this.paidVisit.render();
                    this.paidVisit1 = new ApexCharts(this.$refs.paidVisit1, this.paidVisitOptions);
                    this.paidVisit1.render();
        ...
        Alpine.data('invoiceAdd', () => ({
            ...
            selectedCurrency: 'TRY - Türk Lirası',
            tax: null,
            discount: null,
            shippingCharge: null,
            paymentMethod: '',
                ...
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    ...
                    columns: [
                        ...
                        },
                        {
                            select: 2,
                            render: function (data, cell, row) {
                                return `<div class="flex items-center font-semibold"><div class="p-0.5 bg-white-dark/30 rounded-full w-max ltr:mr-2 rtl:ml-2"><img class="h-8 w-8 rounded-full object-cover" src="assets/images/profile-${row.dataIndex + 1
                                    }.jpeg" /></div>${data}</div>`;
                            },
                        },
                        {
