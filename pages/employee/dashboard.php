        ...
        <div class="pt-5">
                        ...
                        <div class="flex p-5">
                            ...
                            <div class="font-semibold ltr:ml-3 rtl:mr-3">
                                <p class="text-xl dark:text-white-light">
                                    ...
                                    // SQL sorgusu
                                    $sqlProjectTotal = "SELECT COUNT(*) FROM projects WHERE employee LIKE ? AND active = 1 AND (status<>'Tamamlandı' OR status<>'Reddedildi')";
                                    $stmtProjectTotal  = $conn->prepare($sqlProjectTotal);
                                    
                                    // Parametreleri bağla
                                    $stmtProjectTotal ->bind_param('s', $likeName);
                        ...
                        <div class="flex p-5">
                            ...
                            <div class="font-semibold ltr:ml-3 rtl:mr-3">
                                <p class="text-xl dark:text-white-light">
                                    ...
                                    // SQL sorgusu
                                    $sqlProjectDevam = "SELECT COUNT(*) FROM projects WHERE employee LIKE ? AND active = 1 AND (status = 'Devam Eden' OR status = 'Proje')";
                                    
                                    $stmtProjectDevam  = $conn->prepare($sqlProjectDevam);
                                    
                                    // Parametreleri bağla
                                    $stmtProjectDevam->bind_param('s', $likeName);
                        ...
                        <div class="flex p-5">
                            ...
                            <div class="font-semibold ltr:ml-3 rtl:mr-3">
                                <p class="text-xl dark:text-white-light">
                                    <?php
                                    // SQL sorgusu
                                    $sqlProjectPassed = "SELECT COUNT(*) FROM projects WHERE employee LIKE ? AND active = 1 AND dateDeadline < ? AND status NOT IN ('Tamamlandı', 'Reddedildi')";
                                    ...
                                    // Parametreleri bağla
                                    $stmtProjectPassed->bind_param('ss', $likeName, $currentDateTime);
                                ...
                                <h5 class="text-xs text-[#506690]">Gecikmiş</h5>
                            </div>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="flex p-5">
                            ...
                            <div class="font-semibold ltr:ml-3 rtl:mr-3">
                                <p class="text-xl dark:text-white-light">
                                    <?php
                                    // SQL sorgusu
                                    $sqlProjectPassed = "SELECT COUNT(*) FROM projects WHERE employee LIKE ? AND active = 1 AND status = 'Tamamlandı'";
                                    $stmtProjectPassed = $conn->prepare($sqlProjectPassed);
                                    ...
                                    // Parametreleri bağla
                                    $stmtProjectPassed->bind_param('s', $likeName);
            ...
            <div class="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="panel h-full">
                    ...
                    <div class="flex items-center justify-between" style="overflow-y: scroll; flex-direction: column; max-height: 360px;">
                    <?php
                        echo'<link rel="stylesheet" type="text/css" href="pages/manager/dashboard/notice.css" />';
                        
                        $sqlNotice = "SELECT * FROM `notice` ORDER BY `id` DESC";
                ...
                <div class="panel h-full">
                    ...
                    <div class="perfect-scrollbar relative -mr-3 h-[200px] pr-3">
                        <div class="space-y-7">
                        </div>
                    </div>
                </div>
