        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
                ...
                >
                    <div class="relative">
                        <img
                            :src="$store.app.theme === 'dark' || $store.app.isDarkMode ? 'assets/media/system/error/503-dark.svg' : 'assets/media/system/error/503-light.svg'"
                            alt="503"
                            class="mx-auto w-full max-w-xs object-cover md:max-w-xl"
                        />
                        <p class="mt-5 text-base dark:text-white">Maalesef, hizmetimiz şu anda çevrimdışı.</p>
                        <a href="./" class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Ana Sayfa</a>
                    </div>
                </div>
            </div>
