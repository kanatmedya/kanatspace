        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
                ...
                >
                    <div class="relative">
                        <img
                            :src="$store.app.theme === 'dark' || $store.app.isDarkMode ? 'assets/media/system/error/401-dark.svg' : 'assets/media/system/error/401-light.svg'"
                            alt="500"
                            class="mx-auto -mt-10 w-full max-w-xs object-cover md:-mt-14 md:max-w-xl"
                        />
                        <p class="mt-5 text-base dark:text-white">Maalesef, bu sayfayı görüntüleme yetkiniz yok.</p>
