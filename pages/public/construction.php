...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Under Construction | Kanat Medya</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" type="assets/assets/media/system/x-icon" href="uploads/logo/favicon.png" />
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            <div x-data="comingsoon">
                <div class="absolute inset-0">
                    <img src="assets/media/system/auth/bg-gradient.png" alt="assets/media/system" class="h-full w-full object-cover" />
                </div>
                <div
                    class="relative flex min-h-screen items-center justify-center bg-[url(../assets/media/system/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16"
                >
                    <img src="assets/media/system/auth/coming-soon-object1.png" alt="assets/media/system" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                    <img src="assets/media/system/auth/coming-soon-object2.png" alt="assets/media/system" class="absolute left-24 top-0 h-40 md:left-[30%]" />
                    <img src="assets/media/system/auth/coming-soon-object3.png" alt="assets/media/system" class="absolute right-0 top-0 h-[300px]" />
                    <img src="assets/media/system/auth/polygon-object.svg" alt="assets/media/system" class="absolute bottom-0 end-[28%]" />
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="index.html" class="block w-48 lg:w-72 mx-auto 2xl:m-0">
                                ...
                                <div class="mt-24 hidden w-full max-w-[430px] rtl:rotate-y-180 lg:block">
                                    <img src="assets/media/system/auth/coming-soon-cover.svg" alt="Cover assets/media/system" class="w-full" />
                                </div>
                            </div>
                        </div>
                        <div class="relative w-full px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            <div class="mx-auto mt-5 w-full max-w-[550px] lg:mt-16">
                                <a href="index.html" class="mb-8 block lg:hidden">
                                    <img src="uploads/logo/logo.svg" alt="Logo" class="mx-auto w-10" />
                                </a>
                                <div class="mb-12">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span class="relative" x-text="demo1.days"></span>
                                    </div>
                                    <span>:</span>
                                    <div
                                    ...
                                    >
                                        ...
                                        <span class="relative" x-text="demo1.hours"></span>
                                    </div>
                                    <span>:</span>
                                    <div
                                        class="relative inline-flex h-12 w-12 items-center justify-center rounded-md bg-primary-light p-2 sm:h-16 sm:w-16 md:h-24 md:min-w-[96px]"
                                    >
                                        ...
                                        <span class="relative" x-text="demo1.minutes"></span>
                                    </div>
                                    <span>:</span>
                                    <div
                                        class="relative inline-flex h-12 w-12 items-center justify-center rounded-md bg-primary-light p-2 sm:h-16 sm:w-16 md:h-24 md:min-w-[96px]"
                                    >
                                        ...
                                        <span class="relative" x-text="demo1.seconds"></span>
                                    </div>
                                </div>
                                <div class="mb-20 md:mb-32">
                                    ...
                                    <div class="relative mb-10 mt-8">
                                        ...
                                        <button
                                            ...
                                            @click="window.location='index.html'"
                                        >
                                            Subscribe
                                        </button>
                                    </div>
                                    ...
                                    <a href="/logout">    
                                        <button type="button" class="btn btn-gradient inline-flex border-0 text-base shadow-none mt-10">
                                            Ana Sayfa Dön
                                        </button>
                                    </a>
                                </div>
                            ...
                            <p class="absolute bottom-6 w-full text-center dark:text-white">
                                © <span id="footer-year">2024</span>. Kanat Medya All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
