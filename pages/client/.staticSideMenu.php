            ...
            <div class="h-full bg-white dark:bg-[#0e1726]">
                ...
                <div class="flex items-center justify-between px-4 py-3">
                    <a href="/" class="main-logo flex shrink-0 items-center">
                        <img class="ml-[5px] w-8 flex-none" src="uploads/logo/kanatmedyafavicon.ico" alt="image" />
                        <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Kanat Space</span>
                    </a>
                    <a
                        href="javascript:;"
                ...
                <!-- Sidebar -->
                <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }"> <!-- buradaki daha title'ye göre değişmeli -->
                    ...
                    <li class="nav-item">
                        <a href="/" class="group">
                            <div class="flex items-center">
                                ...
                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Ana Sayfa</span>
                            </div>
                        </a>
                    </li>
                            ...
                            <li class="nav-item">
                                <a href="projects" class="group">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Projeler</span>
                                    </div>
                                </a>
                            </li>
